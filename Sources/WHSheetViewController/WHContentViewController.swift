...
@available(iOS 13.0, *)
public class WHContentViewController: UIViewController {
    ...
    public var treatPullBarAsClear: Bool = WHSheetViewController.treatPullBarAsClear {
        didSet {
    ...
    public init(childViewController: UIViewController, options: WHOptions) {
    ...
    private func setupPullBarView() {
        ...
        pullBarView.accessibilityLabel = NSLocalizedString("dismissPresentation", comment: "")
...
@available(iOS 13.0, *)
extension WHContentViewController: UINavigationControllerDelegate {
...
// Delegate
protocol WHContentViewDelegate: AnyObject {
